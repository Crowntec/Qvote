              ...
              <AnimatePresence mode="wait">
                {step === 1 ? (
                    ...
                    >
                      ...
                      <div className="relative">
                        <motion.input
                          ...
                          className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-purple-300 focus:outline-none focus:border-purple-400 focus:ring-2 focus:ring-purple-400/20 transition-all duration-300"
                        ...
                        />
                        <i className="ri-mail-line absolute right-3 top-3 text-purple-300"></i>
                      </div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div className="relative">
                        ...
                        <motion.div
                          ...
                          transition={{ duration: 0.2 }}
                        />
                        <i className="ri-building-line absolute right-3 top-3 text-purple-300"></i>
                      </div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div className="relative">
                        <motion.input
                          ...
                          required
                          animate={{
                            scale: focusedField === 'adminCode' ? 1.02 : 1,
                          }}
                          transition={{ type: "spring", stiffness: 300 }}
                        />
                        <motion.div
                          className="absolute inset-0 rounded-xl border-2 border-purple-400 opacity-0 pointer-events-none"
                          animate={{
                            opacity: focusedField === 'adminCode' ? 1 : 0,
                          }}
                          transition={{ duration: 0.2 }}
                        />
                        <i className="ri-key-line absolute right-3 top-3 text-purple-300"></i>
                      </div>
                    </motion.div>
                  </motion.div>
                ) : (
                  ...
                  >
                    ...
                    >
                      <p className="text-purple-200 text-sm font-medium mb-2">Password Requirements:</p>
              ...
              <div className="flex space-x-3">
                {step === 2 && (
                  <motion.button
                    type="button"
                    onClick={() => setStep(1)}
                    className="flex-1 bg-white/10 border border-white/20 text-white py-3 px-4 rounded-xl font-semibold hover:bg-white/20 transition-all duration-300"
